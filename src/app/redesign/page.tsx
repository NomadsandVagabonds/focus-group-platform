        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                <div className={styles.contentWrapper}>
                    <h2 className={styles.heading}>Real-time perception tracking for qualitative research.</h2>
                    <p className={styles.subHeading}>
                        A minimal, low-latency platform for capturing continuous sentiment data during live focus groups.
                    </p>
...
export default function RedesignPage() {
    return (
        <Suspense fallback={<div>Loading Resonant...</div>}>
            <RedesignContent />
        </Suspense>
    );
}
